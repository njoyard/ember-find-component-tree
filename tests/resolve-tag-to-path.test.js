...
describe('resolveTagToPath', () => {
  ...
  it('returns the full path when it already has the package prefix', () => {
    expect(resolveTagToPath('my-components/components/icon', PKG)).toBe(
  ...
  it('resolves via localImports', () => {
    ...
    expect(resolveTagToPath('Icon', PKG, localImports)).toBe(
      'my-components/components/icon',
    );
  });
  ...
  it('resolves a classic tag when the file exists in the package', () => {
    ...
    expect(resolveTagToPath('Icon', PKG, {}, fixture.addonPath())).toBe(
      'my-components/components/icon',
    );
  });
  ...
  it('resolves a namespaced tag', () => {
    ...
    expect(resolveTagToPath('Form::Field', PKG, {}, fixture.addonPath())).toBe(
      'my-components/components/form/field',
    );
  });

  it('returns null when the file does not exist', () => {
    expect(resolveTagToPath('Icon', PKG, {}, fixture.addonPath())).toBeNull();
  });
});
